/**
 * @file bounds_finding_sinuous_motion_encoder.cpp
 * @brief Fatigue testing platform: Encoder-based bounds finding and sinusoidal motion with UART command interface
 *
