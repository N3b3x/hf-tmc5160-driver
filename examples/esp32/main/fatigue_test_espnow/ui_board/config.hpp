...
static constexpr gpio_num_t OLED_SDA_PIN  = GPIO_NUM_5;   // I2C Data line (SDA)
static constexpr gpio_num_t OLED_SCL_PIN  = GPIO_NUM_23;  // I2C Clock line (SCL)
...
static constexpr gpio_num_t ENCODER_TRA_PIN = GPIO_NUM_21;  // Phase A (CLK) - quadrature input
static constexpr gpio_num_t ENCODER_TRB_PIN = GPIO_NUM_7;   // Phase B (DT) - quadrature input
static constexpr gpio_num_t ENCODER_PSH_PIN = GPIO_NUM_22;  // Push button (SW) - encoder click
...
static constexpr gpio_num_t BTN_BACK_GPIO    = GPIO_NUM_6;   // BACK button (navigate back)
static constexpr gpio_num_t BTN_CONFIRM_GPIO = GPIO_NUM_4;   // CONFIRM button (critical actions)
